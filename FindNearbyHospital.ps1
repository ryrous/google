...
Write-Host "-----------------------------"
Write-Host "Finding Nearby Hospitals..."
Write-Host "-----------------------------"
$Results = Find-NearbyHospital | ConvertTo-Json -Depth 100 | ConvertFrom-Json -Depth 100 -AsHashtable
