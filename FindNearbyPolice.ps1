...
Write-Host "-----------------------------"
Write-Host "Finding Nearby Police Stations..."
Write-Host "-----------------------------"
$Results = Find-NearbyPolice | ConvertTo-Json -Depth 100 | ConvertFrom-Json -Depth 100 -AsHashtable
