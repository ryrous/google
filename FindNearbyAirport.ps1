...
Write-Host "-----------------------------"
Write-Host "Finding Nearby Airports..."
Write-Host "-----------------------------"
$Results = Find-NearbyAirport | ConvertTo-Json -Depth 100 | ConvertFrom-Json -Depth 100 -AsHashtable
