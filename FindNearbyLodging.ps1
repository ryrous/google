...
Write-Host "-----------------------------"
Write-Host "Finding Nearby Lodging..."
Write-Host "-----------------------------"
$Results = Find-NearbyLodging | ConvertTo-Json -Depth 100 | ConvertFrom-Json -Depth 100 -AsHashtable
