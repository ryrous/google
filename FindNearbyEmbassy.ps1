...
Write-Host "-----------------------------"
Write-Host "Finding Nearby Embassies..."
Write-Host "-----------------------------"
$Results = Find-NearbyEmbassy | ConvertTo-Json -Depth 100 | ConvertFrom-Json -Depth 100 -AsHashtable
